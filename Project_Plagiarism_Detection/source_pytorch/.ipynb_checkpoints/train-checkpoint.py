...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_features', type=int, default=3, metavar='IN',
                        help='Input neurons (default: 3)')
    parser.add_argument('--hidden_dim', type=int, default=32, metavar='HIDDEN',
                        help='Neurons in hidden layer (default: 32)')
    parser.add_argument('--output_dim', type=int, default=1, metavar='OUT',
                        help='Output neurons. Due to binary-classification it should be 1 (default: 1)')
