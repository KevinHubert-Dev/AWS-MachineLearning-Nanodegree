...
This repository consists of a bunch of projects I've worked on during my [Udacity Nanodegree "Become a machine learning engineer"](https://www.udacity.com/course/aws-machine-learning-engineer-nanodegree--nd189). Each project is seperated in a directory in this repository and each folder contains code and associated files for deploying ML models using AWS SageMaker, notebooks for various case studies, code exercises, and project files that will be to illustrate parts of the ML workflow and give you practice deploying a variety of ML algorithms.
...
* Use the option to **git clone** the project repository into the notebook instance
