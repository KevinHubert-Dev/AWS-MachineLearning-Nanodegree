...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dim', type=int, default=2, metavar='IN',
                        help='Input dimension for neural network (default: 2)')
    parser.add_argument('--hidden_dim', type=int, default=128, metavar='H',
                        help='Hiddenlayer dimension for neural network (default: 128)')
    parser.add_argument('--output_dim', type=int, default=1, metavar='OUT',
                        help='Output dimension for neural network (default: 1)')
